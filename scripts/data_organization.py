...
ROUGH_DATA_DIR = r'D:\SimBioSys - main\data\rough_data'
IMAGE_DATA_DIR = r'D:\SimBioSys - main\data\organized_data\image'
MASK_DATA_DIR = r'D:\SimBioSys - main\data\organized_data\mask'
ROI_DATA_DIR = r'D:\SimBioSys - main\data\organized_data\roi'
...
def main():
    ...
    roi_paths = get_files_wrt_extension(ROUGH_DATA_DIR, file_extensions['roi'])
    
    copy_files_to_directory(image_paths, IMAGE_DATA_DIR)
    copy_files_to_directory(mask_paths, MASK_DATA_DIR)
    copy_files_to_directory(roi_paths, ROI_DATA_DIR)
    
    print("All Files for Image Segmentation are organzied!")
